            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="geo_city_country_3998f8_idx",
                    ),
                    models.Index(
                        fields=["region", "-population"],
                        name="geo_city_region__09b4eb_idx",
                    ),
                    models.Index(
                        fields=["name_en"], name="geo_city_name_en_09002f_idx"
                    ),
                    models.Index(
                        fields=["name_uk"], name="geo_city_name_uk_69cce8_idx"
                    ),
                    models.Index(
                        fields=["name_ru"], name="geo_city_name_ru_bc3880_idx"
                    ),
                ],
            },
        ),
